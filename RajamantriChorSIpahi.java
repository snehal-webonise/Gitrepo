public class RajaMantri extends Activity {
	...
	dialog.setButton("Exit", new DialogInterface.OnClickListener() {
		...
		public void shuffle(){
		    ...
		    btnPod[b] = (Button)findViewById(R.id.btnPod[b]);
		    btnPod[b].setBackgroundResource(R.drawable.podtlclosed);
		    btnPod[b].setOnClickListener(new OnClickListener() {
			    
			    public void onClick(View v) {
				// TODO Auto-generated method stub
				player1 = solutionArray1;
